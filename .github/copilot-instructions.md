...
Portal de vagas regional (estudo). Frontend em `frontend/`: React 19, Vite, TypeScript, Tailwind v4, React Router, react-icons. Dados mock em `frontend/src/data/`. Testes: Vitest + Testing Library (`npm test`). Backend ainda não existe.
...
- Container: `page-container` (definido em `frontend/src/index.css`)
- Package manager: npm
